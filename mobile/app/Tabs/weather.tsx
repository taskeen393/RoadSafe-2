          ...
          <View style={[styles.detailsSection, { backgroundColor: G.bg }]}>
            <View style={styles.statsGrid}>
              ...
              <View style={[styles.statCard, {
                ...
                <Text style={[styles.statLabel, { color: G.sub }]}>Snow</Text>
              </View>
            </View>

            {/* Landslide Risk Banner */}
            <View style={[styles.riskBanner, { backgroundColor: G.card, borderColor: riskColor }]}>
            ...
            {/* Map Toggle */}
            <TouchableOpacity
              style={[styles.mapToggleBtn, { backgroundColor: G.lightGreen }]}
              onPress={() => setShowMap(!showMap)}
            >
              <Ionicons name={showMap ? "map" : "map-outline"} size={18} color={G.midGreen} />
              <Text style={[styles.mapToggleText, { color: G.midGreen }]}>{showMap ? "Hide Map" : "Show on Map"}</Text>
              <Ionicons name={showMap ? "chevron-up" : "chevron-down"} size={18} color={G.midGreen} />
            </TouchableOpacity>
            ...
            <Text style={[styles.mapHint, { color: G.sub }]}>Tap anywhere on the map to check weather at that location</Text>
          </View>
        )}
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  map: { height: 280, borderRadius: 20, marginBottom: 10, overflow: "hidden" },
