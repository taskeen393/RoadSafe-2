      ...
      >
        ...
        >
          ...
          <View style={[styles.formCard, {
            ...
            <Text style={[styles.formTitle, { color: G.text }]}>Welcome Back</Text>
            <Text style={[styles.formSubtitle, { color: G.sub }]}>Sign in to continue your journey</Text>
            ...
            >
              ...
              <Text style={[styles.altBtnText, { color: G.midGreen }]}>Create New Account</Text>
            </TouchableOpacity>
          </View>
...
const styles = StyleSheet.create({
  ...
  // Hero
  hero: { alignItems: 'center', paddingBottom: 50, overflow: 'hidden' },
  ...
  heroDeco3: { position: 'absolute', top: 30, left: 50, width: 60, height: 60, borderRadius: 30, backgroundColor: 'rgba(255,255,255,0.03)' },
  logoWrap: { marginBottom: 16 },
  logoCircle: {
    width: 80, height: 80, borderRadius: 28, justifyContent: 'center', alignItems: 'center',
    ...Platform.select({
  ...
  heroTagline: { fontSize: 14, color: 'rgba(255,255,255,0.7)', marginTop: 6 },

  // Form Card
  formCard: { marginHorizontal: 20, marginTop: -30, borderRadius: 24, padding: 24 },
  formTitle: { fontSize: 24, fontWeight: '800', letterSpacing: -0.3 },
  ...
  inputIconWrap: { width: 40, height: 40, borderRadius: 12, justifyContent: 'center', alignItems: 'center', marginLeft: 4 },
  textInput: { flex: 1, fontSize: 15, paddingVertical: 14, paddingHorizontal: 12 },
  eyeBtn: { padding: 10 },
