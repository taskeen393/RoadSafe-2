...
const OFF_TOPIC_RESPONSE =
    'I am a Road Safety and Disaster Assistant. I can only answer questions related to road safety, traffic rules, safe driving, accidents, and disaster alerts/preparedness.';

// ── System Prompt ───────────────────────────────────
const SYSTEM_PROMPT = `You are a professional Road Safety and Disaster Assistant for Pakistan.
...
const buildSystemPrompt = (country) => {
    ...
    if (country && country.toLowerCase() !== 'pakistan') {
        prompt += `\n\nIMPORTANT CONTEXT: The user is asking about road safety in ${country}. Tailor your traffic advice, speed limits, driving rules, and emergency numbers to ${country} specifically while keeping the main focus on safety protocols.`;
    }
